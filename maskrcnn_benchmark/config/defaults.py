...
_C.MODEL.ROI_RELATION_HEAD.PART_TYPE = 'half' # half
_C.MODEL.ROI_RELATION_HEAD.PART_HALF_TYPE = 'TD' # TD
_C.MODEL.ROI_RELATION_HEAD.PART_CONTEXT_TYPE = 'Motifs'
_C.MODEL.ROI_RELATION_HEAD.ALPHA = 0.5
