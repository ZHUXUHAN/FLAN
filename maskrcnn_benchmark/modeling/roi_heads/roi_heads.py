...
from .relation_head.relation_head_two_part import build_roi_relation_head as build_roi_relation_head_two_part
...
def build_roi_heads(cfg, in_channels):
    ...
    if cfg.MODEL.RELATION_ON:
        if cfg.MODEL.ROI_RELATION_HEAD.PREDICTOR == 'FLAN2Predictor':
            roi_heads.append(("relation", build_roi_relation_head_two_part(cfg, in_channels)))
        else:
